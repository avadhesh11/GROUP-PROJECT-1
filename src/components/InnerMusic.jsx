        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-6">
                  <button className="flex items-center space-x-2 px-4 py-2 bg-purple-50 hover:bg-purple-100 rounded-xl transition-colors group">
                    ...
                    <span className="text-purple-700 font-medium">{performerData.videoCount || '10'} Videos</span>
                  </button>
                  ...
                  <button className="flex items-center space-x-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors group">
                    ...
                    <span className="text-blue-700 font-medium">{performerData.audioSamples || '25'} Audio</span>
                  </button>
                  
                  <div className="h-8 w-px bg-gray-200"></div>
                  
                  <button className="flex items-center space-x-2 px-4 py-2 bg-green-50 hover:bg-green-100 rounded-xl transition-colors group">
                    <Image size={18} className="text-green-600 group-hover:scale-110 transition-transform" />
                    <span className="text-green-700 font-medium">{performerData.photos || '50'} Photos</span>
                  </button>
            ...
            <div className="mt-6 bg-white rounded-2xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Performance Details</h3>
              
              {/* Key Stats */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="text-center p-4 bg-purple-50 rounded-xl">
                  <Users size={24} className="mx-auto text-purple-500 mb-2" />
                  <div className="font-bold text-purple-700">{performerData.teamSize || '1-5'}</div>
                  <div className="text-sm text-gray-600">Team Size</div>
                </div>
                <div className="text-center p-4 bg-blue-50 rounded-xl">
                  <Clock size={24} className="mx-auto text-blue-500 mb-2" />
                  <div className="font-bold text-blue-700">{performerData.duration || '2-4 hrs'}</div>
                  <div className="text-sm text-gray-600">Duration</div>
                </div>
                <div className="text-center p-4 bg-yellow-50 rounded-xl">
                  <Award size={24} className="mx-auto text-yellow-500 mb-2" />
                  <div className="font-bold text-yellow-700">{performerData.experience || '5+ Years'}</div>
                  <div className="text-sm text-gray-600">Experience</div>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-xl">
                  <Star size={24} className="mx-auto text-green-500 mb-2" />
                  <div className="font-bold text-green-700">{performerData.rating}</div>
              ...
              {/* Skills */}
              <div className="mb-6">
                <h4 className="font-semibold text-gray-900 mb-3">Performance Skills</h4>
              ...
              {/* Event Types */}
              <div className="mb-6">
                <h4 className="font-semibold text-gray-900 mb-3">Suitable Events</h4>
                <div className="flex flex-wrap gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {performerData.awards.map((award, index) => (
                    <div key={index} className="flex items-center p-3 bg-yellow-50 rounded-xl">
                      <Award size={18} className="text-yellow-600 mr-3" />
                      <span className="text-yellow-800 font-medium">{award}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex justify-between items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                    <div className="flex items-center">
                      <Music size={20} className="text-purple-600 mr-2" />
                      <span className="text-purple-700 font-semibold">Complete Show</span>
                    </div>
                    <span className="text-2xl font-bold text-purple-800">₹{parseInt(performerData.price || 50000).toLocaleString()}</span>
                  </div>
                </div>
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Professional Sound System</li>
                  <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Stage Setup & Lighting</li>
                  <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Costume & Makeup</li>
                  <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Travel Within City</li>
                </ul>
              </div>

...
function MusicAndDance() {
  ...
  const PerformerCard = ({ id, image, title, rating, review, location, price, photos, experience, speciality, duration, teamSize }) => (
    <div onClick={() => redirect(id)} className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl dark:shadow-gray-700/50 dark:hover:shadow-gray-600/50 transition-all duration-500 overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-purple-200 dark:hover:border-purple-400 hover:-translate-y-2 cursor-pointer">
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-4 rounded-full shadow-lg hover:bg-white dark:hover:bg-gray-800 transition-colors">
        ...
        {/* Experience Badge */}
        <div className="absolute bottom-4 right-4 bg-gradient-to-r from-purple-500 to-pink-500 dark:from-purple-600 dark:to-pink-600 text-white px-3 py-1 rounded-full">
      ...
      <div className="p-6">
        {/* Title and Location */}
        <div className="mb-4">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors line-clamp-1">
            {title}
          </h3>
        ...
        {/* Pricing Section */}
        <div className="mb-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-xl border dark:border-gray-700">
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">₹{parseInt(price).toLocaleString()}</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">per event</div>
            <div className="mt-2 text-xs text-purple-600 dark:text-purple-400 font-medium">Complete performance package</div>
          </div>
        </div>

        {/* Performance Details */}
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/30 px-3 py-2 rounded-lg border dark:border-blue-800">
            <Clock size={14} className="text-blue-500 dark:text-blue-400" />
            <div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Duration</div>
              <div className="text-sm font-medium text-blue-700 dark:text-blue-300">{duration || "4 hours"}</div>
            </div>
          </div>
          
          <div className="flex items-center space-x-2 bg-green-50 dark:bg-green-900/30 px-3 py-2 rounded-lg border dark:border-green-800">
            <Users size={14} className="text-green-500 dark:text-green-400" />
            <div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Team Size</div>
              <div className="text-sm font-medium text-green-700 dark:text-green-300">{teamSize || "10+ members"}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center space-x-1 bg-orange-50 dark:bg-orange-900/30 px-3 py-1 rounded-full border dark:border-orange-800">
            <Music size={14} className="text-orange-500 dark:text-orange-400" />
            <span className="text-sm text-orange-700 dark:text-orange-300 font-medium">{photos} performances</span>
          </div>
          
          <div className="bg-purple-50 dark:bg-purple-900/30 px-3 py-1 rounded-full border dark:border-purple-800">
            <span className="text-sm text-purple-700 dark:text-purple-300 font-medium">Professional</span>
          </div>
        </div>
        ...
        <div className="flex space-x-3">
          ...
          <button className="px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-purple-300 dark:hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300">
            <Heart size={18} className="text-gray-600 dark:text-gray-400 hover:text-purple-500 dark:hover:text-purple-400" />
          </button>
        </div>
      </div>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="text-gray-600 dark:text-gray-300">
              <span className="font-medium text-gray-900 dark:text-white">{performers.length}</span> performers found
            </div>

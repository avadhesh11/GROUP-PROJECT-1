...
import { Star, MapPin, Camera, Heart, Filter, ChevronDown, Play, Image } from 'lucide-react';
      ...
      <div className="p-6">
        ...
        <div className="mb-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
          <div className="text-center">
            ...
            <div className="mt-2 text-xs text-purple-600 font-medium">All-inclusive package</div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center space-x-1 bg-green-50 px-3 py-1 rounded-full">
            ...
            <span className="text-sm text-green-700 font-medium">{photos} photos</span>
          </div>
          ...
          <div className="bg-yellow-50 px-3 py-1 rounded-full">
            <span className="text-sm text-yellow-700 font-medium">Pro</span>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {photographers.map((photographer) => (
              <PhotographerCard key={photographer._id} {...photographer} />
            ))}
          </div>
        )}
      </div>
